...
export function StarMagnet({ className, style }: MagnetProps) {
        ...
        >
          <defs>
            ...
            <filter
              ...
              height="140%"
            >
              <feOffset in="SourceAlpha" dx="0.4" dy="0.6" />
              <feGaussianBlur stdDeviation="0.6" result="blur" />
              <feFlood floodColor="#000000" floodOpacity="0.14" />
          ...
          <path
            ...
            fill={`url(#star-fill-${id})`}
            stroke={`url(#star-stroke-${id})`}
            strokeWidth="1.1"
            strokeLinejoin="round"
            strokeLinecap="round"
            filter={`url(#star-inner-${id})`}
          />
        </svg>
      </div>
    </MagnetShell>
